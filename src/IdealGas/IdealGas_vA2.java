 ...
 * @author Home
 */
public class IdealGas_vA2 extends javax.swing.JApplet {
    interface MODE {
        final int VOLUME = 0;
    ...
    public void init() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IdealGas_vA2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
