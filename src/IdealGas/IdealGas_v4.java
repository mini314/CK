 ...
 * @author Home
 */
public class IdealGas_v4 extends javax.swing.JApplet {
    ...
    public void init() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IdealGas_v4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
public class timeListener implements ActionListener 
    ...
    private void temperatureSliderStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_temperatureSliderStateChanged
        // TODO add your handling code here:
        final double COLOR_SCALE = ((double)temperatureSlider.getValue())/100.0; // It varies from 0 to 1
        GraphicPanel.setBackground(new java.awt.Color(142+(int)(88*COLOR_SCALE),180+(int)(5*COLOR_SCALE),227-(int)(43*COLOR_SCALE)));
