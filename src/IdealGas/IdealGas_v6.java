 ...
 * @author Home
 */
public class IdealGas_v6 extends javax.swing.JApplet {
    interface MODE {
        final int VOLUME = 0;
    ...
    public void init() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IdealGas_v6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
