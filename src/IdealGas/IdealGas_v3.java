 ...
 * @author Home
 */
public class IdealGas_v3 extends javax.swing.JApplet {
    ...
    public void init() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IdealGas_v3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
