...
import FourierSeries.FourierSeries_v4;
 ...
 * @author Home
 */
public class IdealGas_v7 extends javax.swing.JApplet {
    interface MODE {
        final int VOLUME = 0;
    ...
    public void init() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IdealGas_v7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
