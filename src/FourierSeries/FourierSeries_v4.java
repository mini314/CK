...
public class FourierSeries_v4 extends javax.swing.JApplet {
    interface SHAPE {
...
class CoefficientGraphPanel extends JPanel {
    ...
    public void init() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FourierSeries_v4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        parabolaRadioButton = new javax.swing.JRadioButton();
        ...
        nMaxLabel.setText("n_max");

        shapeLabel.setText("trial function");

        buttonGroup1.add(rectangularRadioButton);
        rectangularRadioButton.setSelected(true);
        rectangularRadioButton.setText("rectangular");
        ...
        buttonGroup1.add(parabolaRadioButton);
        parabolaRadioButton.setText("parabola");
        parabolaRadioButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                parabolaRadioButtonActionPerformed(evt);
            }
        });

        buttonGroup1.add(cosineRadioButton);
        cosineRadioButton.setText("cosine");
    ...
    private javax.swing.JRadioButton parabolaRadioButton;
